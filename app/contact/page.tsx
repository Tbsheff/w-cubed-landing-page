        ...
        <div className="container mx-auto px-4 lg:px-6 relative">
          <motion.div className="max-w-4xl mx-auto text-center space-y-4" {...fadeInUp}>
            ...
            <p className="text-lg lg:text-xl text-muted-foreground">
              Tell us about your water equipment needs or reach out directly to the right
              representative. We respond within one business day across Utah, Nevada, Idaho, and
              Wyoming.
            </p>
          </motion.div>
        </div>
            ...
            <Card className="p-6 bg-white border-[#4986C8]/20">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div className="grid gap-2 text-sm md:grid-cols-3 md:gap-4 flex-1">
                  <div className="flex justify-between md:flex-col md:gap-1 md:text-center">
