                                ...
                                <motion.div key={project.id} variants={fadeInUp}>
                                    <Card className="h-full hover:shadow-lg transition-shadow overflow-hidden">
                                        ...
                                        <CardContent className="space-y-4">
                                            {project.excerpt && <CardDescription className="text-base">{project.excerpt}</CardDescription>}
                        ...
                        {regular.map((project) => (
                            <motion.div key={project.id} variants={fadeInUp}>
                                <Card className="h-full hover:shadow-lg transition-shadow overflow-hidden">
                                    ...
                                    <CardContent className="space-y-4">
                                        {project.excerpt && <CardDescription className="text-sm line-clamp-3">{project.excerpt}</CardDescription>}
